    ...
    entries: [
      {
        ...
        description:
          "Compiles the given regular expression string into a reusable Pattern object",
      ...
      },
      {
        ...
        description:
          "Compiles pattern with one or more bitwise-OR flags (e.g. Pattern.CASE_INSENSITIVE)",
        example:
      ...
      },
      {
        ...
        description:
          "Quick one-liner check if regex matches the entire input CharSequence",
      ...
      },
      {
        ...
        description:
          "Creates a Matcher object that will match the given input against this pattern",
      ...
      },
      {
        ...
        description:
          "Splits the input around matches of this pattern into a String[] array",
      ...
      },
      {
        ...
        description:
          "Splits input with threshold limit on the number of matching substrings",
      ...
      },
      {
        ...
        description:
          "Creates a Stream<String> from the input split around matches (Java 8+)",
      ...
      },
      {
        ...
        description:
          "Creates a Predicate<String> for filtering streams using matcher.find() (Java 8+)",
      ...
      },
      {
        ...
        description:
          "Creates a Predicate<String> that matches entire string using matcher.matches() (Java 11+)",
      ...
      },
      {
        ...
        description:
          "Returns a literal pattern String wrapped in \\Q...\\E for exact matching",
      ...
      },
      {
        ...
        description:
          "Returns the original regular expression string from which this pattern was compiled",
        example: 'p.pattern() → "\\\\d+"',
        tryPattern: null,
      },
      {
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        syntax: "m.find(start)",
        description:
          "Resets this matcher and attempts to find next match starting from the specified index",
      ...
      },
      {
        syntax: "m.group(n)",
        description:
          "Returns the input subsequence captured by the given 1-based group index",
      ...
      },
      {
        syntax: "m.group(name)",
        description:
          "Returns the input subsequence captured by the named group (?<name>...) (Java 7+)",
      ...
      },
      {
        ...
        description:
          "Returns start (inclusive) and end (exclusive) character offset of the match",
      ...
      },
      {
        ...
        description:
          "Returns start / end offset of the subsequence captured by group index or name",
      ...
      },
      {
        ...
        description:
          "Replaces every subsequence of input sequence that matches pattern with replacement",
      ...
      },
      {
        ...
        description:
          "Replaces first subsequence of input that matches pattern with replacement",
      ...
      },
      {
        ...
        description:
          "Replaces each match with result of applying function to MatchResult (Java 9+)",
      ...
      },
      {
        syntax: "m.results()",
        description:
          "Returns a Stream<MatchResult> of all match results in input order (Java 9+)",
      ...
      },
      {
        ...
        description:
          "Non-terminal step: appends preceding text and replacement to StringBuffer/StringBuilder",
      ...
      },
      {
        ...
        description:
          "Terminal step: appends remaining input text after last match to StringBuilder (Java 9+)",
    ...
    entries: [
      {
        ...
        description:
          "Returns true if and only if the entire string matches the given regular expression",
      ...
      },
      {
        ...
        description:
          "Replaces each substring matching regex with replacement string (supports $1, ${name})",
      ...
      },
      {
        ...
        description:
          "Replaces first substring matching regex with replacement string",
      ...
      },
      {
        ...
        description:
          "Splits string around matches of regex; trailing empty strings are discarded",
      ...
      },
      {
        ...
        description:
          "Splits string around matches with control on result array length (limit < 0 retains trailing empty strings)",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        description:
          "Enables canonical equivalence matching (e.g. character with accent vs combining accent)",
      ...
      },
      {
        ...
        description:
          "Specifies that pattern contains literal characters with no metacharacter meanings",
    ...
    entries: [
      {
        syntax: '"\\\\d", "\\\\b", "\\\\s"',
        description:
          "Double backslash in Java strings: Java compiler uses 1st escape, regex engine uses 2nd",
      ...
      },
      {
        syntax: '"""\\\\d+"""',
        description:
          "Java 15+ Text Blocks (triple quotes) simplify multiline regex, though backslashes still escape",
        example: '"""\n\\\\d{4}-\\\\d{2}-\\\\d{2}\n"""',
        tryPattern: null,
      },
      {
        syntax: "(?<name>X)",
        description:
          'Named capturing group — captures matching text accessible via matcher.group("name")',
      ...
      },
      {
        syntax: "\\k<name>",
        description:
          "Named backreference within the regex pattern to an earlier named group",
      ...
      },
      {
        syntax: "${name} / $1",
        description:
          "Named and indexed group backreferences in replaceAll() replacement strings",
      ...
      },
      {
        syntax: "[a-z&&[def]]",
        description:
          "Character class intersection: matches characters present in both sets ('d', 'e', or 'f')",
      ...
      },
      {
        syntax: "[a-z&&[^bc]]",
        description:
          "Character class subtraction: matches a through z except 'b' and 'c'",
      ...
      },
      {
        syntax: "[a-d[m-p]]",
        description:
          "Character class union: matches union of sets (equivalent to [a-dm-p])",
      ...
      },
      {
        ...
        description:
          "POSIX character classes: Lowercase [a-z], Uppercase [A-Z], Digits [0-9]",
      ...
      },
      {
        ...
        description:
          "POSIX alphabetic [a-zA-Z], alphanumeric, and punctuation characters",
      ...
      },
      {
        ...
        description:
          "Java character property classes matching Character.isLowerCase() / isWhitespace()",
      ...
      },
      {
        ...
        description:
          "Unicode Scripts / Blocks and Categories (\\p{Sc} for currency symbols: $, €, ¥)",
      ...
      },
      {
        syntax: "\\Q...\\E",
        description:
          "Literal quotation — all characters between \\Q and \\E are treated as literal text",
      ...
      },
      {
        syntax: "\\A, \\Z, \\z, \\G",
        description:
          "Boundaries: \\A (beginning of input), \\Z (end except final terminator), \\z (strict end of input), \\G (end of previous match)",
        example: "\\\\A[a-z]+\\\\z",
        tryPattern: null,
      },
    ],
...
export const javaRecipes: JavaRecipe[] = [
  {
    ...
    description:
      "Extract structured components from logs or strings using named groups (?<name>...) and matcher.group(name).",
...
public class LogParser {
  ...
  },
  {
    ...
    description:
      "Use matcher.results() to process all matches as a standard Java Stream<MatchResult>.",
...
public class StreamMatches {
  ...
  },
  {
    ...
    description:
      "Transform matches dynamically using matcher.replaceAll(Function<MatchResult, String>).",
    code: `import java.util.regex.Matcher;
import java.util.regex.Pattern;
...
public class CurrencyConverter {
  ...
  },
  {
    ...
    description:
      "Use possessive quantifiers (*+, ++) to eliminate catastrophic backtracking and safeguard performance.",
    code: `import java.util.regex.Matcher;
import java.util.regex.Pattern;
...
public class SafeParsing {
  ...
  },
  {
    ...
    description:
      "Filter collections directly with Pattern.asPredicate() (find) or Pattern.asMatchPredicate() (exact match).",
    code: `import java.util.List;
import java.util.regex.Pattern;
...
public class FilterList {
  ...
  },
  {
    ...
    description:
      "Use appendReplacement() and appendTail() for fine-grained match transformations in legacy Java code.",
    code: `import java.util.regex.Matcher;
import java.util.regex.Pattern;
...
export const javaNavCards: NavCard[] = [
  ...
  },
  {
    ...
    title: "Python",
    description:
      "re module — named groups (?P<name>), verbose mode, and Python-specific flags.",
    icon: "🐍",
  },
  {
    href: "/examples",
